...
namespace LeaveApply.Controllers
{
    ...
    public class EmployeesController : ControllerBase
    {
        ...
        public EmployeesController(LeaveContext context)
        {
            _context = context;
        }
        ...
        {
            var user = await _context.Employees.FirstOrDefaultAsync(u => u.EmpName == logger.EmpName);
            ...
            if (user.EmpPassword != logger.EmpPassword)
            {
